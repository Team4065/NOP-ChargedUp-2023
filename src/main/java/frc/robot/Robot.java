...
public class Robot extends TimedRobot {
  ...
  public void disabledPeriodic() {
    // Displaying trajectories on ShuffleBoard
    if (RobotContainer.autoMap.get(RobotContainer.m_chooser.getSelected()) != "nothing" && RobotContainer.autoMap.get(RobotContainer.m_chooser.getSelected()) != "test") {
